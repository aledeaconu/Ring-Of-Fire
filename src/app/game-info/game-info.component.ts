...
export class GameInfoComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    { title: 'Thumbmaster', description: 'Pick a mate. Your mate must always drink when you drink and the other way around.' },
    { title: 'Men', description: 'All men drink.' },
    { title: 'Quizmaster', description: 'All men drink.' },
    {
  ...
  ngOnChanges(): void {
    if (this.card) {
      ...
      this.desciption = this.cardAction[cardNumber - 1].description;
    }
  }
}
